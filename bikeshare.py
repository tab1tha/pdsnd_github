...
def user_stats(df):
    """Displays statistics on bikeshare users including the user types and their respective 
    frequencies. Also, if in cases where the gender information of the bikers is provided, the gender 
    distribution and age distribution is highlighted"""
